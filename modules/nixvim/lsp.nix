...
}:
{
  ...
  lsp = {
    completion = {
      enable = config.gmarlervim.completion.tool == "native";
    ...
    }
    {
      ...
      callback.__raw = ''
        function(args)
          ...
          local web_tools = require("gmarlervim.web_tools")
    ...
    }
    {
      ...
      callback.__raw = ''
        function(args)
          ...
          if
            jdtls_client
            and _G.gmarlervim_jdtls
            and _G.gmarlervim_jdtls.is_large_gradle_workspace(jdtls_client.config.root_dir)
          then
